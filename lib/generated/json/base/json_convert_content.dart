...
class JsonConvert {
  ...
  static M? _getListChildType<M>(List<Map<String, dynamic>> data) {
    ...
    if (<ResultData>[] is M) {
      return data.map<ResultData>((Map<String, dynamic> e) =>
          ResultData.fromJson(e)).toList() as M;
    }
    if (<BaseConfigEntity>[] is M) {
      return data.map<BaseConfigEntity>((Map<String, dynamic> e) =>
          BaseConfigEntity.fromJson(e)).toList() as M;
    }
    if (<BaseConfigData>[] is M) {
      return data.map<BaseConfigData>((Map<String, dynamic> e) =>
          BaseConfigData.fromJson(e)).toList() as M;
    }
    if (<BaseConfigDataData>[] is M) {
      return data.map<BaseConfigDataData>((Map<String, dynamic> e) =>
          BaseConfigDataData.fromJson(e)).toList() as M;
    }
    ...
    if (<OssTokenEntity>[] is M) {
      return data.map<OssTokenEntity>((Map<String, dynamic> e) =>
          OssTokenEntity.fromJson(e)).toList() as M;
    }
    if (<OssTokenData>[] is M) {
      return data.map<OssTokenData>((Map<String, dynamic> e) =>
          OssTokenData.fromJson(e)).toList() as M;
    }
    if (<OssTokenDataData>[] is M) {
      return data.map<OssTokenDataData>((Map<String, dynamic> e) =>
          OssTokenDataData.fromJson(e)).toList() as M;
    }
