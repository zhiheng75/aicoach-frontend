...
class FlutterToNative {
  ...
  static Future<void> jumpToAndroidMethod() async {
    final String result =
        await methodChannelPlatform.invokeMethod('jumpToAndroidPage');
  }

  //微信登录
  static Future<String> jumpToWechatLogin() async {
    final String result =
        await methodChannelPlatform.invokeMethod("jumpToWechatLogin");
    return result;
  }
  ...
  static Future<int> jumpToWechatPay(String bean) async {
    ...
    final int result =
        await methodChannelPlatform.invokeMethod("jumpToWechatPay", bean);
    return result;
  }
  ...
  static Future<int> jumpToALiPay(String bean) async {
    final int result =
        await methodChannelPlatform.invokeMethod("jumpToALiPay", bean);
    return result;
  }
