...
class _CurriculumEvaluationPageState extends State<CurriculumEvaluationPage>
  ...
  late LessonFeedbackDetailBean lessonFeedbackDetailData;
  @override
  void initState() {
    super.initState();
    _controller.text = '';
    ...
    if (widget.stepDetailBean.data.evaluationStatus == 2) {
      _curriculumEvaluationPagePresenter.getLessonFeedbackDetail(
                  ...
                  Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          RatingBar(
                            initialRating:
                                widget.stepDetailBean.data.evaluationStatus == 2
                                    ? lessonFeedbackDetailData.data.star
                                        .toDouble()
                                    : starNum,
                          ...
                          child: Semantics(
                            ...
                            child: TextField(
                              ...
                              decoration: const InputDecoration(
                                hintText: "说出你的课程建议把",
                                hintStyle:
                                    TextStyle(color: Colours.color_999999),
                    ...
                    child: Row(
                      ...
                      children: [
                        Container(
                          ...
                          child: widget.stepDetailBean.data.evaluationStatus ==
                                  2
                              ? LoadAssetImage(
                                  lessonFeedbackDetailData.data.anonymous == 1
                                      ? "select_img2"
                                      : "unselect_img2",
                                  width: 15.0,
                                  height: 15.0,
                          ...
                          onTap: () {
                            if (_controller.text.isNotEmpty) {
                              _curriculumEvaluationPagePresenter
                                  .postLessonFeedback(
                                      widget.stepDetailBean.data.lessonId
                                          .toString(),
                                      _isSelect ? "1" : "0",
  ...
  void sendLessonFeedbackDetailSuccess(LessonFeedbackDetailBean data) {
    // TODO: implement sendLessonFeedbackDetailSuccess
    lessonFeedbackDetailData = data;
    isLoading = true;
    setState(() {});
  }
}
