                    ...
                    GestureDetector(
                      onTap: () {
                        NavigatorUtils.pushResult(
                            context, LoginRouter.changeBindPhonePage,
                            arguments: _settingPresenter.userInfo, (result) {
                          setState(() {});
                        });
                      },
                      child: phoneBindState(
                          0, "手机号", _settingPresenter.hasBindPhone),
                    ),
                      ...
                      child: Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            Text(
                              "${_settingPresenter.appVersion}版本",
                              style: TextStyle(
  ...
  Widget phoneBindState(int type, String name, bool hasBind) {
    return Row(
      children: [
        ...
        Text(
          name,
          style: const TextStyle(fontSize: 15, color: Colours.color_111B44),
        ),
        const Expanded(child: Gaps.empty),
        Text(
          hasBind ? "去换绑" : "去绑定",
