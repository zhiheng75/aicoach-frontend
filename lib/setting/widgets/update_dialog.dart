      ...
      children: <Widget>[
        ...
        GestureDetector(
          ...
          child: Container(
            ...
            child:const Center(
              child:Text("取消", style:const TextStyle(fontSize: 13,color: Colours.color_3389FF),) ,
            ) ,
          ),
        ),
        ...
        GestureDetector(
          ...
          child: Container(
            ...
            child:const Center(
              child: Text("立即升级",style: const TextStyle(fontSize: 13,color: Colors.white),),
            ),
          ),
        ),
