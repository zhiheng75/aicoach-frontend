...
class _MyAppState extends State<Demo> {
  ...
  List<String> remoteSample = [
    ...
    '', // 'assets/samples/sample_xxx.pcm', // pcmWebM
    'https://flutter-sound.canardoux.xyz/extract/02-opus.webm', // 'assets/samples/sample_opus.webm', // opusWebM
    'https://flutter-sound.canardoux.xyz/extract/03-vorbis.webm', // 'assets/samples/sample_vorbis.webm', // vorbisWebM
  ];
...
*/
  ...
  Widget recorderAssetImage() {
    if (onStartRecorderPressed() == null) {
      return const Text("正在播放");
    }
    return (recorderModule.isStopped) ? const Text("录音") : const Text("停止");
  }
            ...
            SizedBox(
              ...
              child: ClipOval(
                child: TextButton(
                  ...
                  //padding: EdgeInsets.all(8.0),
                  child:
                      onStartPlayerPressed() != null ? Text("播放") : Text("停止"),
                ),
              ),
            ),
            SizedBox(
            ...
            SizedBox(
              ...
              child: ClipOval(
                child: TextButton(
                  ...
                  //padding: EdgeInsets.all(8.0),
                  child:
                      onStopPlayerPressed() != null ? Text("停止") : Text("停止空"),
                ),
              ),
            ),
          ],
