...
class LoginInfoData {
  ...
  factory LoginInfoData.fromJson(Map<String, dynamic> json) =>
      $LoginInfoDataFromJson(json);
...
class LoginInfoDataData {
  ...
  factory LoginInfoDataData.fromJson(Map<dynamic, dynamic> json) =>
      $LoginInfoDataDataFromJson(json);
