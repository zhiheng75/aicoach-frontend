...
class RecordError extends StatefulWidget {
  const RecordError({
    Key? key,
    required this.show,
  ...
  final bool show;
  final RecordErrorController controller;

  @override
  State<RecordError> createState() => _RecordErrorState();
}

class _RecordErrorState extends State<RecordError> {
  ...
  @override
  void didUpdateWidget(covariant RecordError oldWidget) {
            ...
            children: <Widget>[
              ...
              SizedBox(
                ...
                child: ValueListenableBuilder(
                  valueListenable: widget.controller.isInSendButton,
                  builder: (_, isInSendButton, __) => isInSendButton
                      ? const SizedBox()
                    ...
                    return Container(
                      ...
                      decoration: BoxDecoration(
                        image: DecorationImage(
                          image: AssetImage(
                            isInSendButton
                                ? 'assets/images/fasong_active.png'
                                : 'assets/images/fasong_disabled.png',
                          ),
                          fit: BoxFit.fill,
                        ),
                      ),
...
class RecordErrorController {
  RecordErrorController();
