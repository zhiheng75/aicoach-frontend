...
class _PurchasePageState extends State<PurchasePage>
    with
        BasePageMixin<PurchasePage, PurchasePresenter>,
            ...
            Container(
              ...
              child: RichText(
                ...
                TextSpan(
                    text: category,
                    style: TextStyle(
                        fontSize: Dimens.font_sp13, color: Colors.white)),
                            ...
                            itemBuilder: (context, index) {
                              return GestureDetector(
                                onTap: () {
                                  selectIndex = index;
                                  for (int i = 0;
                                      i < _purchasePresenter.goodList.length;
                                      i++) {
                                    _purchasePresenter.goodList[i].isSelect =
                                        false;
                                  }
                                  _purchasePresenter.goodList[index].isSelect =
                                      true;
                                  setState(() {});
                                },
                                child: purchaseItem(
                                    _purchasePresenter.goodList[index]),
                              );
                            }),
                        ...
                        GestureDetector(
                          onTap: () {
                            if (agreeAgreement) {
                              // 微信支付
                              if (wxPay) {
                                _purchasePresenter.wxChatPay(
                                    _purchasePresenter.goodList[selectIndex].id,
                                    _purchasePresenter
                                        .goodList[selectIndex].price,
                                    true);
                              }
                              // 支付宝
                              if (aliPay) {
                                _purchasePresenter.aliPay(
                                    _purchasePresenter.goodList[selectIndex].id,
                                    _purchasePresenter
                                        .goodList[selectIndex].price,
                                    true);
                              ...
                              // 苹果支付
                              if (applePay) {
                                _purchasePresenter.applePay(_purchasePresenter
                                    .goodList[selectIndex].id);
                              }
                            } else {
    ...
    return Stack(
      children: [
        Container(
          ...
          padding:
              const EdgeInsets.only(left: 22, right: 22, top: 10, bottom: 30),
          decoration: BoxDecoration(
            image: DecorationImage(
                image: ImageUtils.getAssetImage(
                  bean.isSelect == true
                      ? "purchase_select_img"
                      : "purchase_unselect_img",
                ),
                fit: BoxFit.fill),
          ),
          child: Column(
            ...
            children: [
              ...
              Text(
                bean.desc,
                style: TextStyle(
                    fontSize: Dimens.font_sp13, color: Colours.color_546092),
              ),
            ],
          ),
        ),
                    ...
                    children: [
                      Container(
                        ...
                        margin: EdgeInsets.only(
                            left: Dimens.w_dp5, right: Dimens.w_dp5),
        ...
        return Row(
          children: [
            ...
            Expanded(
              ...
              "微信支付",
              style: TextStyle(
                  fontSize: Dimens.font_sp13, color: Colours.color_111B44),
            )),
            LoadAssetImage(
              isCheck == true ? "select_img" : "unselect_img",
              width: 17,
              height: 17,
            ),
          ],
      ...
      children: [
        Container(
            ...
            child: LoadAssetImage(
              agree == true ? "select_img" : "unselect_img",
              width: 15.0,
              height: 15.0,
            )),
        Gaps.hGap4,
