                    ...
                    children: <Widget>[
                      ...
                      session(
                        ...
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: <Widget>[
                            sessionChild('（1）每次购买的会员权益包单独计时效和学习时长，个人中心显示剩余学习时长及有效包的截止时间。'),
                            sessionChild('举例说明，年包在购买后1个月内使用完了学习时长，这时年包权益已兑现，年包权益清零。此时购买1个月包，则月包自购买日开始计时，1个月后到期，1个月内享有15小时学习权益。个人中心显示剩余学习时长为月包的剩余学习时长，有效时长为月包的截止时间。'),
                            sessionChild('（2）年包在没用完学习时长的情况下，购买了月包，则两个包的学习时长同时有效，优先使用先到期的学习时长。'),
                          ],
                        ),
                      ),
                    ],
