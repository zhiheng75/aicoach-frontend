...
class Gaps {
  ...
  static Widget hGap20 = SizedBox(width: Dimens.w_dp20);
  static Widget hGap26 = SizedBox(width: Dimens.w_dp26);
  static Widget hGap30 = SizedBox(width: Dimens.w_dp30);
  ...
  static Widget vGap6 = SizedBox(height: Dimens.h_dp6);
  static Widget vGap7 = SizedBox(height: Dimens.h_dp7);
  static Widget vGap8 = SizedBox(height: Dimens.h_dp8);
  static Widget vGap9 = SizedBox(height: Dimens.h_dp9);
  ...
  static Widget vGap35 = SizedBox(height: Dimens.h_dp35);
  ...
  static Widget vGap70 = SizedBox(height: Dimens.h_dp70);
