...
import 'package:Bubble/scene/view/teaching_dialogue_view.dart';
...
class TeachingDialoguePage extends StatefulWidget {
  const TeachingDialoguePage({
    super.key,
    required this.onEnd,
  });
  ...
  @override
  State<TeachingDialoguePage> createState() => _TeachingDialoguePageState();
}

class _TeachingDialoguePageState extends State<TeachingDialoguePage>
    with
        BasePageMixin<TeachingDialoguePage, TeachingDialoguepresenter>,
        AutomaticKeepAliveClientMixin<TeachingDialoguePage>,
        WidgetsBindingObserver
    implements TeachingDialogueView {
  final ChatWebsocket _chatWebsocket = ChatWebsocket();
  final MediaUtils _mediaUtils = MediaUtils();
  late HomeProvider _homeProvider;
  late TeachingDialoguepresenter _teachingDialoguepresenter;
  ...
  @override
  TeachingDialoguepresenter createPresenter() {
    _teachingDialoguepresenter = TeachingDialoguepresenter();
    return _teachingDialoguepresenter;
  }
